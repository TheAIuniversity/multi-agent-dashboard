...
`;
  ...
  const agentPath = path.join(agentsDir, 'claude-team-orchestrator.md');
...
"""
Claude Code Dashboard Hook - Auto-configured by Claude Team Orchestrator Agent
"""
...
def main():
    ...
    app_name = os.environ.get("APP_NAME", "claude-team-orchestrator-agent")
    ...
    event_data = {
        ...
        "summary": f"Claude Team Orchestrator: {hook_event_name}"
    }
