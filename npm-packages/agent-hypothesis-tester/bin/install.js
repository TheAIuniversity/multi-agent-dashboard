...
console.log(chalk.gray('Installing: ') + chalk.yellow('Hypothesis Tester'));
...
`;
  ...
  const agentPath = path.join(agentsDir, 'hypothesis-tester.md');
  ...
  console.log(chalk.gray('  • Name: ') + chalk.cyan('Hypothesis Tester'));
...
"""
Claude Code Dashboard Hook - Auto-configured by Hypothesis Tester Agent
"""
...
def main():
    ...
    app_name = os.environ.get("APP_NAME", "hypothesis-tester-agent")
    ...
    event_data = {
        ...
        "summary": f"Hypothesis Tester: {hook_event_name}"
    }
