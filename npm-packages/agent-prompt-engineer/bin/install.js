...
`;
  ...
  const agentPath = path.join(agentsDir, 'prompt-engineer.md');
...
"""
Claude Code Dashboard Hook - Auto-configured by Prompt Engineer Agent
"""
...
def main():
    ...
    app_name = os.environ.get("APP_NAME", "prompt-engineer-agent")
    ...
    event_data = {
        ...
        "summary": f"Prompt Engineer: {hook_event_name}"
    }
