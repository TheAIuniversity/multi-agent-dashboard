...
`;
  ...
  const agentPath = path.join(agentsDir, 'security-specialist.md');
...
"""
Claude Code Dashboard Hook - Auto-configured by Security Specialist Agent
"""
...
def main():
    ...
    app_name = os.environ.get("APP_NAME", "security-specialist-agent")
    ...
    event_data = {
        ...
        "summary": f"Security Specialist: {hook_event_name}"
    }
