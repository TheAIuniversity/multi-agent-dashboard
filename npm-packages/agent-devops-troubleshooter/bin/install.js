...
`;
  ...
  const agentPath = path.join(agentsDir, 'devops-troubleshooter.md');
...
"""
Claude Code Dashboard Hook - Auto-configured by DevOps Troubleshooter Agent
"""
...
def main():
    ...
    app_name = os.environ.get("APP_NAME", "devops-troubleshooter-agent")
    ...
    event_data = {
        ...
        "summary": f"DevOps Troubleshooter: {hook_event_name}"
    }
