...
`;
  ...
  const agentPath = path.join(agentsDir, 'api-devrel-writer.md');
...
"""
Claude Code Dashboard Hook - Auto-configured by API DevRel Writer Agent
"""
...
def main():
    ...
    app_name = os.environ.get("APP_NAME", "api-devrel-writer-agent")
    ...
    event_data = {
        ...
        "summary": f"API DevRel Writer: {hook_event_name}"
    }
