...
`;
  ...
  const agentPath = path.join(agentsDir, 'project-shipper.md');
...
"""
Claude Code Dashboard Hook - Auto-configured by Project Shipper Agent
"""
...
def main():
    ...
    app_name = os.environ.get("APP_NAME", "project-shipper-agent")
    ...
    event_data = {
        ...
        "summary": f"Project Shipper: {hook_event_name}"
    }
