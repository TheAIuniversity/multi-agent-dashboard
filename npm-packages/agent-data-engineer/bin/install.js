...
`;
  ...
  const agentPath = path.join(agentsDir, 'data-engineer.md');
...
"""
Claude Code Dashboard Hook - Auto-configured by Data Engineer Agent
"""
...
def main():
    ...
    app_name = os.environ.get("APP_NAME", "data-engineer-agent")
    ...
    event_data = {
        ...
        "summary": f"Data Engineer: {hook_event_name}"
    }
