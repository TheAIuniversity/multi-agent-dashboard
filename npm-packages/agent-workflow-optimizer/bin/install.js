...
`;
  ...
  const agentPath = path.join(agentsDir, 'workflow-optimizer.md');
...
"""
Claude Code Dashboard Hook - Auto-configured by Workflow Optimizer Agent
"""
...
def main():
    ...
    app_name = os.environ.get("APP_NAME", "workflow-optimizer-agent")
    ...
    event_data = {
        ...
        "summary": f"Workflow Optimizer: {hook_event_name}"
    }
