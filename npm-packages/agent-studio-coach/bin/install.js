...
`;
  ...
  const agentPath = path.join(agentsDir, 'studio-coach.md');
...
"""
Claude Code Dashboard Hook - Auto-configured by Studio Coach Agent
"""
...
def main():
    ...
    app_name = os.environ.get("APP_NAME", "studio-coach-agent")
    ...
    event_data = {
        ...
        "summary": f"Studio Coach: {hook_event_name}"
    }
