...
`;
  ...
  const agentPath = path.join(agentsDir, 'infrastructure-maintainer.md');
...
"""
Claude Code Dashboard Hook - Auto-configured by Infrastructure Maintainer Agent
"""
...
def main():
    ...
    app_name = os.environ.get("APP_NAME", "infrastructure-maintainer-agent")
    ...
    event_data = {
        ...
        "summary": f"Infrastructure Maintainer: {hook_event_name}"
    }
