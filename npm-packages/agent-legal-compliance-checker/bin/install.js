...
`;
  ...
  const agentPath = path.join(agentsDir, 'legal-compliance-checker.md');
...
"""
Claude Code Dashboard Hook - Auto-configured by Legal Compliance Checker Agent
"""
...
def main():
    ...
    app_name = os.environ.get("APP_NAME", "legal-compliance-checker-agent")
    ...
    event_data = {
        ...
        "summary": f"Legal Compliance Checker: {hook_event_name}"
    }
