...
`;
  ...
  const agentPath = path.join(agentsDir, 'mobile-app-builder.md');
...
"""
Claude Code Dashboard Hook - Auto-configured by Mobile App Builder Agent
"""
...
def main():
    ...
    app_name = os.environ.get("APP_NAME", "mobile-app-builder-agent")
    ...
    event_data = {
        ...
        "summary": f"Mobile App Builder: {hook_event_name}"
    }
