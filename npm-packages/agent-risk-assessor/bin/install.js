...
console.log(chalk.gray('Installing: ') + chalk.yellow('Risk Assessor'));
...
`;
  ...
  const agentPath = path.join(agentsDir, 'risk-assessor.md');
  ...
  console.log(chalk.gray('  • Name: ') + chalk.cyan('Risk Assessor'));
...
"""
Claude Code Dashboard Hook - Auto-configured by Risk Assessor Agent
"""
...
def main():
    ...
    app_name = os.environ.get("APP_NAME", "risk-assessor-agent")
    ...
    event_data = {
        ...
        "summary": f"Risk Assessor: {hook_event_name}"
    }
