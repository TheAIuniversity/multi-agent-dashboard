...
`;
  ...
  const agentPath = path.join(agentsDir, 'analytics-reporter.md');
...
"""
Claude Code Dashboard Hook - Auto-configured by Analytics Reporter Agent
"""
...
def main():
    ...
    app_name = os.environ.get("APP_NAME", "analytics-reporter-agent")
    ...
    event_data = {
        ...
        "summary": f"Analytics Reporter: {hook_event_name}"
    }
