...
`;
  ...
  const agentPath = path.join(agentsDir, 'network-engineer.md');
...
"""
Claude Code Dashboard Hook - Auto-configured by Network Engineer Agent
"""
...
def main():
    ...
    app_name = os.environ.get("APP_NAME", "network-engineer-agent")
    ...
    event_data = {
        ...
        "summary": f"Network Engineer: {hook_event_name}"
    }
