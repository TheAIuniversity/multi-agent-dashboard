...
console.log(chalk.gray('Installing: ') + chalk.yellow('Statistical Analyst'));
...
`;
  ...
  const agentPath = path.join(agentsDir, 'statistical-analyst.md');
  ...
  console.log(chalk.gray('  • Name: ') + chalk.cyan('Statistical Analyst'));
...
"""
Claude Code Dashboard Hook - Auto-configured by Statistical Analyst Agent
"""
...
def main():
    ...
    app_name = os.environ.get("APP_NAME", "statistical-analyst-agent")
    ...
    event_data = {
        ...
        "summary": f"Statistical Analyst: {hook_event_name}"
    }
