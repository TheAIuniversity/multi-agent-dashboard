...
`;
  ...
  const agentPath = path.join(agentsDir, 'research-data-collector.md');
...
"""
Claude Code Dashboard Hook - Auto-configured by Research Data Collector Agent
"""
...
def main():
    ...
    app_name = os.environ.get("APP_NAME", "research-data-collector-agent")
    ...
    event_data = {
        ...
        "summary": f"Research Data Collector: {hook_event_name}"
    }
