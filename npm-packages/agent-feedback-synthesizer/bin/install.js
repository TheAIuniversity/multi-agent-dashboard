...
`;
  ...
  const agentPath = path.join(agentsDir, 'feedback-synthesizer.md');
...
"""
Claude Code Dashboard Hook - Auto-configured by Feedback Synthesizer Agent
"""
...
def main():
    ...
    app_name = os.environ.get("APP_NAME", "feedback-synthesizer-agent")
    ...
    event_data = {
        ...
        "summary": f"Feedback Synthesizer: {hook_event_name}"
    }
