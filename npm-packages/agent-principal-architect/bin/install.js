...
`;
  ...
  const agentPath = path.join(agentsDir, 'principal-architect.md');
...
"""
Claude Code Dashboard Hook - Auto-configured by Principal Architect Agent
"""
...
def main():
    ...
    app_name = os.environ.get("APP_NAME", "principal-architect-agent")
    ...
    event_data = {
        ...
        "summary": f"Principal Architect: {hook_event_name}"
    }
