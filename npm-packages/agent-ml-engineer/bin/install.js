...
`;
  ...
  const agentPath = path.join(agentsDir, 'ml-engineer.md');
...
"""
Claude Code Dashboard Hook - Auto-configured by ML Engineer Agent
"""
...
def main():
    ...
    app_name = os.environ.get("APP_NAME", "ml-engineer-agent")
    ...
    event_data = {
        ...
        "summary": f"ML Engineer: {hook_event_name}"
    }
