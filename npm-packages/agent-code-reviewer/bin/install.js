...
`;
  ...
  const agentPath = path.join(agentsDir, 'code-reviewer.md');
...
"""
Claude Code Dashboard Hook - Auto-configured by Code Reviewer Agent
"""
...
def main():
    ...
    app_name = os.environ.get("APP_NAME", "code-reviewer-agent")
    ...
    event_data = {
        ...
        "summary": f"Code Reviewer: {hook_event_name}"
    }
