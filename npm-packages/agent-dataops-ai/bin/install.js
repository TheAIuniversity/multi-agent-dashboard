...
`;
  ...
  const agentPath = path.join(agentsDir, 'dataops-ai.md');
...
"""
Claude Code Dashboard Hook - Auto-configured by DataOps AI Agent
"""
...
def main():
    ...
    app_name = os.environ.get("APP_NAME", "dataops-ai-agent")
    ...
    event_data = {
        ...
        "summary": f"DataOps AI: {hook_event_name}"
    }
