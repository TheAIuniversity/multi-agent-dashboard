...
`;
  ...
  const agentPath = path.join(agentsDir, 'incident-responder.md');
...
"""
Claude Code Dashboard Hook - Auto-configured by Incident Responder Agent
"""
...
def main():
    ...
    app_name = os.environ.get("APP_NAME", "incident-responder-agent")
    ...
    event_data = {
        ...
        "summary": f"Incident Responder: {hook_event_name}"
    }
