...
`;
  ...
  const agentPath = path.join(agentsDir, 'database-specialist.md');
...
"""
Claude Code Dashboard Hook - Auto-configured by Database Specialist Agent
"""
...
def main():
    ...
    app_name = os.environ.get("APP_NAME", "database-specialist-agent")
    ...
    event_data = {
        ...
        "summary": f"Database Specialist: {hook_event_name}"
    }
