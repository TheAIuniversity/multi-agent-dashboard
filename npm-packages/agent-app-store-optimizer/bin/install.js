...
`;
  ...
  const agentPath = path.join(agentsDir, 'app-store-optimizer.md');
...
"""
Claude Code Dashboard Hook - Auto-configured by App Store Optimizer Agent
"""
...
def main():
    ...
    app_name = os.environ.get("APP_NAME", "app-store-optimizer-agent")
    ...
    event_data = {
        ...
        "summary": f"App Store Optimizer: {hook_event_name}"
    }
