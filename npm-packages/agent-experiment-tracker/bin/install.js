...
`;
  ...
  const agentPath = path.join(agentsDir, 'experiment-tracker.md');
...
"""
Claude Code Dashboard Hook - Auto-configured by Experiment Tracker Agent
"""
...
def main():
    ...
    app_name = os.environ.get("APP_NAME", "experiment-tracker-agent")
    ...
    event_data = {
        ...
        "summary": f"Experiment Tracker: {hook_event_name}"
    }
