...
`;
  ...
  const agentPath = path.join(agentsDir, 'data-payments-integration.md');
...
"""
Claude Code Dashboard Hook - Auto-configured by Data Payments Integration Agent
"""
...
def main():
    ...
    app_name = os.environ.get("APP_NAME", "data-payments-integration-agent")
    ...
    event_data = {
        ...
        "summary": f"Data Payments Integration: {hook_event_name}"
    }
