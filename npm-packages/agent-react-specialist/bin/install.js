...
`;
  ...
  const agentPath = path.join(agentsDir, 'react-specialist.md');
...
"""
Claude Code Dashboard Hook - Auto-configured by React Specialist Agent
"""
...
def main():
    ...
    app_name = os.environ.get("APP_NAME", "react-specialist-agent")
    ...
    event_data = {
        ...
        "summary": f"React Specialist: {hook_event_name}"
    }
