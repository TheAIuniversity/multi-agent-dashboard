...
`;
  ...
  const agentPath = path.join(agentsDir, 'python-backend-specialist.md');
...
"""
Claude Code Dashboard Hook - Auto-configured by Python Backend Specialist Agent
"""
...
def main():
    ...
    app_name = os.environ.get("APP_NAME", "python-backend-specialist-agent")
    ...
    event_data = {
        ...
        "summary": f"Python Backend Specialist: {hook_event_name}"
    }
