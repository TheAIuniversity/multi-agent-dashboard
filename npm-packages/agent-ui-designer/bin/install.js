...
`;
  ...
  const agentPath = path.join(agentsDir, 'ui-designer.md');
...
"""
Claude Code Dashboard Hook - Auto-configured by UI Designer Agent
"""
...
def main():
    ...
    app_name = os.environ.get("APP_NAME", "ui-designer-agent")
    ...
    event_data = {
        ...
        "summary": f"UI Designer: {hook_event_name}"
    }
