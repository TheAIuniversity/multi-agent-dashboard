...
`;
  ...
  const agentPath = path.join(agentsDir, 'debugging-specialist.md');
...
"""
Claude Code Dashboard Hook - Auto-configured by Debugging Specialist Agent
"""
...
def main():
    ...
    app_name = os.environ.get("APP_NAME", "debugging-specialist-agent")
    ...
    event_data = {
        ...
        "summary": f"Debugging Specialist: {hook_event_name}"
    }
