...
`;
  ...
  const agentPath = path.join(agentsDir, 'whimsy-injector.md');
...
"""
Claude Code Dashboard Hook - Auto-configured by Whimsy Injector Agent
"""
...
def main():
    ...
    app_name = os.environ.get("APP_NAME", "whimsy-injector-agent")
    ...
    event_data = {
        ...
        "summary": f"Whimsy Injector: {hook_event_name}"
    }
