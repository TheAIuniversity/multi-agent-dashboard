...
`;
  ...
  const agentPath = path.join(agentsDir, 'brand-guardian.md');
...
"""
Claude Code Dashboard Hook - Auto-configured by Brand Guardian Agent
"""
...
def main():
    ...
    app_name = os.environ.get("APP_NAME", "brand-guardian-agent")
    ...
    event_data = {
        ...
        "summary": f"Brand Guardian: {hook_event_name}"
    }
