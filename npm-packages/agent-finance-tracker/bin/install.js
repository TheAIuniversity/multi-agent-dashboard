...
`;
  ...
  const agentPath = path.join(agentsDir, 'finance-tracker.md');
...
"""
Claude Code Dashboard Hook - Auto-configured by Finance Tracker Agent
"""
...
def main():
    ...
    app_name = os.environ.get("APP_NAME", "finance-tracker-agent")
    ...
    event_data = {
        ...
        "summary": f"Finance Tracker: {hook_event_name}"
    }
