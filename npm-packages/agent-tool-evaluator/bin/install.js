...
`;
  ...
  const agentPath = path.join(agentsDir, 'tool-evaluator.md');
...
"""
Claude Code Dashboard Hook - Auto-configured by Tool Evaluator Agent
"""
...
def main():
    ...
    app_name = os.environ.get("APP_NAME", "tool-evaluator-agent")
    ...
    event_data = {
        ...
        "summary": f"Tool Evaluator: {hook_event_name}"
    }
