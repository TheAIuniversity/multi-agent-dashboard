...
`;
  ...
  const agentPath = path.join(agentsDir, 'frontend-developer.md');
...
"""
Claude Code Dashboard Hook - Auto-configured by Frontend Developer Agent
"""
...
def main():
    ...
    app_name = os.environ.get("APP_NAME", "frontend-developer-agent")
    ...
    event_data = {
        ...
        "summary": f"Frontend Developer: {hook_event_name}"
    }
