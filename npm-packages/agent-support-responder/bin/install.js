...
`;
  ...
  const agentPath = path.join(agentsDir, 'support-responder.md');
...
"""
Claude Code Dashboard Hook - Auto-configured by Support Responder Agent
"""
...
def main():
    ...
    app_name = os.environ.get("APP_NAME", "support-responder-agent")
    ...
    event_data = {
        ...
        "summary": f"Support Responder: {hook_event_name}"
    }
