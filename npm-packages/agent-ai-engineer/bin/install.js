...
`;
  ...
  const agentPath = path.join(agentsDir, 'ai-engineer.md');
...
"""
Claude Code Dashboard Hook - Auto-configured by AI Engineer Agent
"""
...
def main():
    ...
    app_name = os.environ.get("APP_NAME", "ai-engineer-agent")
    ...
    event_data = {
        ...
        "summary": f"AI Engineer: {hook_event_name}"
    }
