...
`;
  ...
  const agentPath = path.join(agentsDir, 'performance-benchmarker.md');
...
"""
Claude Code Dashboard Hook - Auto-configured by Performance Benchmarker Agent
"""
...
def main():
    ...
    app_name = os.environ.get("APP_NAME", "performance-benchmarker-agent")
    ...
    event_data = {
        ...
        "summary": f"Performance Benchmarker: {hook_event_name}"
    }
