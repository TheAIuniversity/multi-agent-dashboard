...
`;
  ...
  const agentPath = path.join(agentsDir, 'terraform-specialist.md');
...
"""
Claude Code Dashboard Hook - Auto-configured by Terraform Specialist Agent
"""
...
def main():
    ...
    app_name = os.environ.get("APP_NAME", "terraform-specialist-agent")
    ...
    event_data = {
        ...
        "summary": f"Terraform Specialist: {hook_event_name}"
    }
