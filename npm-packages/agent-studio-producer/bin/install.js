...
`;
  ...
  const agentPath = path.join(agentsDir, 'studio-producer.md');
...
"""
Claude Code Dashboard Hook - Auto-configured by Studio Producer Agent
"""
...
def main():
    ...
    app_name = os.environ.get("APP_NAME", "studio-producer-agent")
    ...
    event_data = {
        ...
        "summary": f"Studio Producer: {hook_event_name}"
    }
