...
`;
  ...
  const agentPath = path.join(agentsDir, 'visual-storyteller.md');
...
"""
Claude Code Dashboard Hook - Auto-configured by Visual Storyteller Agent
"""
...
def main():
    ...
    app_name = os.environ.get("APP_NAME", "visual-storyteller-agent")
    ...
    event_data = {
        ...
        "summary": f"Visual Storyteller: {hook_event_name}"
    }
