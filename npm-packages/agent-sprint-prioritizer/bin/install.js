...
`;
  ...
  const agentPath = path.join(agentsDir, 'sprint-prioritizer.md');
...
"""
Claude Code Dashboard Hook - Auto-configured by Sprint Prioritizer Agent
"""
...
def main():
    ...
    app_name = os.environ.get("APP_NAME", "sprint-prioritizer-agent")
    ...
    event_data = {
        ...
        "summary": f"Sprint Prioritizer: {hook_event_name}"
    }
