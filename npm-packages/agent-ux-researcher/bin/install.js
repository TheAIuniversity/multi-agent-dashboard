...
`;
  ...
  const agentPath = path.join(agentsDir, 'ux-researcher.md');
...
"""
Claude Code Dashboard Hook - Auto-configured by UX Researcher Agent
"""
...
def main():
    ...
    app_name = os.environ.get("APP_NAME", "ux-researcher-agent")
    ...
    event_data = {
        ...
        "summary": f"UX Researcher: {hook_event_name}"
    }
