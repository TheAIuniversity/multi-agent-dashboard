...
`;
  ...
  const agentPath = path.join(agentsDir, 'backend-architect.md');
...
"""
Claude Code Dashboard Hook - Auto-configured by Backend Architect Agent
"""
...
def main():
    ...
    app_name = os.environ.get("APP_NAME", "backend-architect-agent")
    ...
    event_data = {
        ...
        "summary": f"Backend Architect: {hook_event_name}"
    }
