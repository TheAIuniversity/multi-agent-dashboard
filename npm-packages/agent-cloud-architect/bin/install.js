...
`;
  ...
  const agentPath = path.join(agentsDir, 'cloud-architect.md');
...
"""
Claude Code Dashboard Hook - Auto-configured by Cloud Architect Agent
"""
...
def main():
    ...
    app_name = os.environ.get("APP_NAME", "cloud-architect-agent")
    ...
    event_data = {
        ...
        "summary": f"Cloud Architect: {hook_event_name}"
    }
