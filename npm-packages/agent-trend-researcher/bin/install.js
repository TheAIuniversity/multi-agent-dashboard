...
`;
  ...
  const agentPath = path.join(agentsDir, 'trend-researcher.md');
...
"""
Claude Code Dashboard Hook - Auto-configured by Trend Researcher Agent
"""
...
def main():
    ...
    app_name = os.environ.get("APP_NAME", "trend-researcher-agent")
    ...
    event_data = {
        ...
        "summary": f"Trend Researcher: {hook_event_name}"
    }
