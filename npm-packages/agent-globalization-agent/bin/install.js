...
`;
  ...
  const agentPath = path.join(agentsDir, 'globalization-agent.md');
...
"""
Claude Code Dashboard Hook - Auto-configured by Globalization Agent Agent
"""
...
def main():
    ...
    app_name = os.environ.get("APP_NAME", "globalization-agent-agent")
    ...
    event_data = {
        ...
        "summary": f"Globalization Agent: {hook_event_name}"
    }
