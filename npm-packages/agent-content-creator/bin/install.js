...
`;
  ...
  const agentPath = path.join(agentsDir, 'content-creator.md');
...
"""
Claude Code Dashboard Hook - Auto-configured by Content Creator Agent
"""
...
def main():
    ...
    app_name = os.environ.get("APP_NAME", "content-creator-agent")
    ...
    event_data = {
        ...
        "summary": f"Content Creator: {hook_event_name}"
    }
