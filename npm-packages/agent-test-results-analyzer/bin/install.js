...
`;
  ...
  const agentPath = path.join(agentsDir, 'test-results-analyzer.md');
...
"""
Claude Code Dashboard Hook - Auto-configured by Test Results Analyzer Agent
"""
...
def main():
    ...
    app_name = os.environ.get("APP_NAME", "test-results-analyzer-agent")
    ...
    event_data = {
        ...
        "summary": f"Test Results Analyzer: {hook_event_name}"
    }
